...
preview?.summary;
  ...
  return (
    <div
      className="modal fade show d-block renewal-modal-backdrop"
      style={{ background: 'rgba(0,0,0,.65)', zIndex: 1075 }}
    >
      {/* ✅ ستايلز مسؤولة بس عن استجابة الموديول للشاشات الصغيرة — مفيش تعديل على منطق ولا استايل موجود */}
      <style>{`
        .renewal-modal-dialog { max-width: 500px; }
        ...
        .renewal-modal-content-scroll {
          max-height: calc(100vh - 3.5rem);
          overflow-y: auto;
        }
      `}</style>

      <div className="modal-dialog modal-dialog-centered renewal-modal-dialog">
        <div
          className="modal-content renewal-modal-content-scroll"
          style={{ background: '#1e293b', border: '1px solid #334155', color: '#e2e8f0' }}
        >

          <div
            className="modal-header"
            style={{ borderColor: '#334155', background: '#1e293b', position: 'sticky', top: 0, zIndex: 1 }}
          >
            <h5 className="modal-title" style={{ color: '#f1f5f9', fontSize: 15 }}>
              <i className="fas fa-sync-alt me-2 text-primary" />
              Renew / Change Plan
...
,
  ...
  />
            ...
            <div
              ...
              style={{ borderColor: '#334155', background: '#1e293b', position: 'sticky', bottom: 0 }}
            >
              <button type="button" className="btn btn-secondary btn-sm" onClick={onClose}>Cancel</button>
              <button type="submit" className="btn btn-primary btn-sm" disabled={submitting || previewLoading || !preview}>
                {submitting
