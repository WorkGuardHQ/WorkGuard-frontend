...
const [timezone, setTimezone] =
  ...
  return (
    <>
      {/* toast.type بيستخدم أسماء Bootstrap ('success' | 'danger' | 'warning')
          والكومبوننت المشترك بيفهم ('success' | 'error' | 'warning')
          فبنعمل mapping بسيط وقت العرض بس، من غير أي تغيير في showToast نفسها */}
      <Toast
        show={!!toast}
      ...
      <Toast
        ...
        confirmText={t('devices.actions.delete')}
