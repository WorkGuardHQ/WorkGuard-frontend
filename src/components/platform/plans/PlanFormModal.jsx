...
const updateField =
  ...
  return (
    ...
    >
      {/* ✅ ستايلز استجابة الموديول للشاشات الصغيرة بس — بدون أي تعديل على منطق أو استايل موجود */}
      <style>{`
        ...
        .plan-form-modal-content-scroll {
          max-height: calc(100vh - 3.5rem);
          overflow-y: auto;
        }
      `}</style>

      <div className="modal-dialog modal-dialog-centered modal-lg plan-form-modal-dialog">
        <div
          className="modal-content plan-form-modal-content-scroll"
